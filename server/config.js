...
exports.creds = {
    ...
    redirectUrl: `${process.env.APP_URL}/auth/openid/return`,
    ...
    cookieEncryptionKeys: [
        {'key': process.env.KEY, 'iv': process.env.IV},
        {'key': process.env.ROLLOVER_KEY, 'iv': process.env.ROLLOVER_IV}
    ],
...
exports.destroySessionUrl = `https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri=${process.env.APP_URL}`;
...
exports.databaseUri = process.env.MONGO_URL;
